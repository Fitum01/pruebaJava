package com.example.pruebajava.ui.salir;
...
public class SalirFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //pp = root.findViewById(R.id.idtxtPruebaPerfilado);

        //pp.setText(arrayUltInf[0].getIdTInforme() + " - " + arrayUltInf[0].getDescTI() + "el dia: " + arrayUltInf[0].getFechaInformeSig());
